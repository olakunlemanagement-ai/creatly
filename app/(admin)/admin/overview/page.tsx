    ...
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard label="Published resources" value={resourceCount ?? 0} icon={FileBox} href="/admin/resources" accent />
          <StatCard label="Active creators" value={creatorCount ?? 0} icon={Users} href="/admin/creators" accent />
          <StatCard label="Active categories" value={categoryCount ?? 0} icon={Tag} href="/admin/categories" accent />
          <StatCard label="Pending review" value={submittedCount ?? 0} icon={ClipboardList} href="/admin/review" alert={Boolean(submittedCount)} />
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard label="Total users" value={userCount ?? 0} icon={Users} href="/admin/users" />
          <StatCard label="Active subscribers" value={activeSubCount ?? 0} icon={CreditCard} href="/admin/subscriptions" accent />
          <StatCard label="Cancelled" value={inactiveSubCount ?? 0} icon={UserX} href="/admin/subscriptions" />
          <StatCard label="Downloads this month" value={downloadsThisMonth ?? 0} icon={TrendingUp} href="/admin/analytics" />
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <StatCard label="Total all-time downloads" value={totalDownloads ?? 0} icon={Download} href="/admin/analytics" />
        </div>
      </section>
