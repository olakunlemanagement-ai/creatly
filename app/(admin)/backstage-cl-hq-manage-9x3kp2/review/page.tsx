...
// When CREATOR_AUTO_APPROVE=true (default), creator assets are auto-approved
// on submit, so this queue will normally be empty. The queue still functions
// correctly when the flag is flipped to false.
...
export default async function AdminReviewPage() {
  ...
  const { data: creators } = creatorIds.length
    ? await supabase.from("creators").select("id, name, slug").in("id", creatorIds)
    : { data: [] };
